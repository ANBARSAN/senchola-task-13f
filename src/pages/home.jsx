     ...
     <div className="homepage">  
        <div className="row">
            ...
            <div className="myProfile my-3">
                <img src="/images/pho.jpg" style={{height:"30px", width:"40px",borderRadius:"60%"}}/>
                Anbarasan A
            </div>
            <div className="mainlogo mb-3">
                
            <FaUserFriends color="blue" className="log"fontSize="2rem" />
            <div className="mt-2 px-2-1">Friends</div>
            </div>
            <div className="mainlogo mb-3">
                <MdGroups2   color="blue"fontSize="2rem"/>
                <div className="mt-2 px-2-1">Groups</div>
            </div>
            <div className="mainlogo mb-3">
                <AiOutlineShop color="blue"  fontSize="2rem"/>
                <div className="mt-2 px-2-1">Market Place</div>
            </div>
            <div className="mainlogo mb-3">
                <MdOndemandVideo   color="blue"fontSize="2rem"/>
                <div className="mt-2 px-2-1">Video</div>
            </div>
            <div className="mainlogo mb-3">
                < FcClock color="blue" fontSize="2rem"/>
                <div className="mt-2 px-2-1">Memories</div>
            </div>
           
            <div className="mainlogo mb-3">
                < BsFlag fontSize="2rem" color="blue"className="log"/>
                <div className="mt-2 px-2-1">pages</div>
            </div>
            <div className="mainlogo mb-3">
                <  MdEventAvailable fontSize="2rem" color="blue" className="log"/>
                <div className="mt-2 px-2-1">Events</div>
            </div>
            <div className="mainlogo mb-3">
                < BsFillBarChartLineFill fontSize="2rem" color="blue"  className="log"/>
                <div className="mt-2 px-2-1">Ads Manager</div>
            </div>
            <div className="mainlogo mb-3">
                < BsFillBookmarkFill color="purple" fontSize="2rem"/>
                <div className="mt-2 px-2-1">Saved</div>
            </div>
            <div className="Pro">
                <FaAngleDown  fontSize="1rem"/>
                <div className="mt-2 px-2-1">See More</div>
            </div>
            <br></br>
            ...
            <div className="MainArea">
                ...
                <div className="addStory">
                    ...
                    <div className="message">
                        <div className="text">
                            <div className="Post">
                                <img src="/images/pho.jpg" alt="PIC"/>
...
<div className="col-3">
            ...
            <div className="list mb-3">
                <div className="contact-list mb-3">
                    <img src="/images/polar.jpg"  style={{height:"30px",width:"30px" ,borderRadius:"50%"}}/>
                    Anbu
                </div>
                <div className="contact-list mb-3">
                    <img src="images/pho.jpg"  style={{height:"30px",width:"30px" ,borderRadius:"50%"}}/>
                    Devi
                </div>
                <div className="contact-list mb-3">
                    <img src="images/picv.jpg"  style={{height:"30px",width:"30px" ,borderRadius:"50%"}}/>
                    Vicky
                </div>
                <div className="contact-list mb-3">
                    <img src="images/picv.jpg"  style={{height:"30px",width:"30px" ,borderRadius:"50%"}}/>
